...
import com.telandash.intranet.config.WebConfig;
import com.telandash.intranet.security.filtrers.JwtAuthenticationFilter;
import com.telandash.intranet.security.filtrers.JwtAuthorizationFilter;
import com.telandash.intranet.security.jwt.JwtUtils;
import com.telandash.intranet.services.UserDetailsServiceImpl;
...
public class WebSecurityConfig {
    ...
    public CorsConfigurationSource corsConfigurationSource() {
        ...
        configuration.setAllowedOrigins(Arrays.asList("http://localhost:3000", "http://localhost", "http://192.168.1.232")); // Especificar los orígenes permitidos
